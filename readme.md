...
### 3.1.  Ticker Symbols from pytickersymbols
...
## 5.1 Price to Earnings Ratio over Time
![image_1](img/pe_ratio_over_time.png)

## 5.2 Price to Earnings Ratio vs Money Supply
![image_1](img/pe_ratio_vs_money_supply.png)

## 5.2 S&P 500 Price vs Money Supply
...
## 7.2. Local installation for Airflow 
...
### 7.3.1. Configure AWS Permissions:
...
### 7.3.2. Configure the Redshift Cluster:
